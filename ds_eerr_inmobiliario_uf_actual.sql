/*create table ds_eerr_inmobiliario_uf_actual(
...
*/
delete from ds_eerr_inmobiliario_uf_actual;

insert into ds_eerr_inmobiliario_uf_actual (nombre_proyecto, obra, item, gasto, por_gastar, total, number_row, tipo) 
...
(
	...
	(
		...
		(
			...
			(select apgi.obra, max(apgi.fecha_actualizacion) as fecha_actualizacion 
			from avance_por_gastar_inmobiliaria apgi
			group by apgi.obra) as actualizacion, item_uf as iu
